...
local FitNetsOptim, _ = torch.class('FitNetsOptim')

-- Not modified from OpenFaceOptim
...
function FitNetsOptim.weight_bias_parameters(module)
...
-- Not modified from OpenFaceOptim
function FitNetsOptim:__init(model, optState, checkpoint_data)
    assert(model)
